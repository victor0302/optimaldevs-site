...
const BG = "#FAFAF8"
const SURFACE = "#F0EFE8"
const BORDER = "#DDD9CF"
const INK = "#1C1917"
const MUTED = "#78716C"
const ACCENT = "#6B8E5E"
const ACCENT_LIGHT = "#E7EFE0"
    ...
    <div className="min-h-screen pt-8" style={{ backgroundColor: BG, color: INK }}>
      ...
      <section className="relative overflow-hidden pt-20 pb-24 md:pt-28 md:pb-32">
        <div aria-hidden="true" className="absolute inset-0 pointer-events-none flex items-center justify-center">
          <span className="font-display italic font-light select-none whitespace-nowrap leading-none text-[18rem] md:text-[28rem]" style={{ color: ACCENT, opacity: 0.08 }}>
            Optimal
          </span>
        </div>
