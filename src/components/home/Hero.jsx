...
export function Hero() {
  return (
    <section className="relative overflow-hidden pt-20 pb-10 md:pt-28 md:pb-14">
      {/* Deliberately bare. The serif-era watermark was removed with the
          restyle, and the block cursor that briefly replaced it read as a
          stray square rather than a caret. The headline carries the section
          on its own. */}
